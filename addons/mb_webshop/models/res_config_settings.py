...
class ResConfigSettings(models.TransientModel):
    ...
    mb_ready_online_payment = fields.Boolean(related="website_id.mb_ready_online_payment")
    ...
    mb_ready_product_count = fields.Integer(related="website_id.mb_ready_product_count")
    mb_ready_payment_count = fields.Integer(related="website_id.mb_ready_payment_count")
    mb_ready_fulfilment_count = fields.Integer(related="website_id.mb_ready_fulfilment_count")
    ...
    def action_mb_open_mail_servers(self):
        return self.env["ir.actions.actions"]._for_xml_id("base.action_ir_mail_server_list")
